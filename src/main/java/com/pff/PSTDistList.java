...
public class PSTDistList extends PSTMessage {
     ...
     * @param localDescriptorItems additional external items that represent this
     * object.
     */
     ...
     * @return array of entries that can either be PSTDistList.OneOffEntry or a
     * PSTObject, generally PSTContact.
     */
